...
const Contact = () => {
  return (
    <section class="relative z-10 overflow-hidden bg-white 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p class="text-body-color mb-9 text-base leading-relaxed">
                ...
                adiqua minim veniam quis nostrud exercitation ullamco. Cras
                scelerisque varius ante fermentum iaculis. Cras mollis in justo
                non aliquam. Phasellus a vestibulum eros, a blandit enim. Class
