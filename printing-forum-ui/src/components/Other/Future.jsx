    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <div className="flex flex-col lg:flex-row justify-between gap-8">
        ...
        <div className="w-full lg:w-8/12 ">
          <img
            ...
            src="https://3dprintanje.hr/wp-content/uploads/2020/06/Creality-CP-01-3D-Printer-CNC-Laser-Engraving-200-200-200-mm-CP-01-24386.jpg"
            alt="Printer"
          />
        </div>
      </div>
      ...
      <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
        ...
        <div className="w-full lg:w-8/12 ">
          <img
            className="w-full h-full"
            src="https://m.media-amazon.com/images/I/71m1Tf4cIUL._AC_UF1000,1000_QL80_.jpg"
            alt="Printer2"
          />
        </div>
      </div>
